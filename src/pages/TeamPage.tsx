...
const TeamPage = () => {
  ...
  // ── Build ordered category map from Supabase order ───────────────────────
                    ...
                    {members.map((member: any) => (
                      ...
                      >
                        ...
                        <div className="p-2.5 sm:p-4">
                          ...
                          <h3 className="text-[0.65rem] sm:text-sm font-bold text-[#0d2340] leading-snug line-clamp-1">{member.name}</h3>
                          <p className="text-[0.55rem] sm:text-xs text-[#bfa06f] font-semibold mt-0.5 line-clamp-1">{member.role}</p>
                          <p className="text-[0.55rem] sm:text-xs text-[#6a6a6a] mt-1 line-clamp-2 leading-snug hidden sm:block">{member.specialization}</p>
          ...
          >
            ...
            <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
              {selectedMember.description && (
                <p className="text-xs sm:text-sm text-[#4a4a4a] leading-relaxed">{selectedMember.description}</p>
              )}
              {selectedMember.expertise?.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-2 sm:mb-3">
                    <Award className="h-3 w-3 sm:h-4 sm:w-4 text-[#bfa06f]" />
                    <h4 className="text-[0.65rem] sm:text-xs font-semibold uppercase tracking-widest text-[#0d2340]">Areas of Expertise</h4>
                  </div>
              ...
              {selectedMember.education?.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-2 sm:mb-3">
                    ...
                    <h4 className="text-[0.65rem] sm:text-xs font-semibold uppercase tracking-widest text-[#0d2340]">Education</h4>
                  </div>
